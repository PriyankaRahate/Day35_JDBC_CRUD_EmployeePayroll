...
public class EmployeePayrollNewDBService<Employee_payroll_Data, Employee_payroll_D> {
    ...
    private List<Employee_payroll_D> getEmployeePayrollDataUsingSQLQuery(String sql) {
	...
	private List<Employee_payroll_D> getEmployeePayrollData(ResultSet resultSet) {
        List<Employee_payroll_D> employeePayrollList = new ArrayList<>();
        ...
        try {
            while (resultSet.next()) {
                ...
                employeePayrollList.add((Employee_payroll_D) new Employee_payroll_Data(id, name, salary, startDate, gender, companyName,
